...
import {type GenerateRequest, generateSong} from "~/actions/generation";
                    ...
                    <TabsContent value="simple" className='mt-6 space-y-6'>
                        <div className='flex flex-col gap-3'>
                            ...
                            <Textarea
                                ...
                                placeholder='A dreamy lofi chill song, perfect for studying of relaxing'
                    ...
                    <TabsContent value='custom' className='mt-6 space-y-6'>
                        <div className='flex flex-col gap-3'>
                            ...
                            <Textarea
                                placeholder={
                                    lyricsMode === "write"
                                    ? "Add your own lyrics here" : "Describe your lyrics, e.g., a sad song about lost love"
                                }
                                value={lyrics}
